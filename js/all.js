...
/* ---------------------------------------------
 ...
 --------------------------------------------- */
    ...
    if ((selectedLanguage == 'english') || (selectedLanguage == 'swedish')) {
    $(".language select").val(selectedLanguage);
    var sel = $(".language select").val(selectedLanguage);
    if (selectedLanguage == 'english') {
            $(".english-block").css("display", "block");
            $(".swedish-block").css("display", "none");
            $(".english-inline-block").css("display", "inline-block");
            $(".swedish-inline-block").css("display", "none");  
            
        }else{
            $(".english-block").css("display", "none");
            $(".swedish-block").css("display", "block");
            $(".english-inline-block").css("display", "none");
            $(".swedish-inline-block").css("display", "inline-block");
